 ...
 */
public class Logger {
	  private static boolean dynamicLogging = false;
       ...
       */
      public static void debug(Class objClass,
                               Object msg,
                               Throwable thrown) {
       ...
       * @param msg the message to be logged
       */
      public static void error(Class objClass,
                               Object msg) {
       ...
       * @param msg the message to be logged
       */
      public static void fatal(Class objClass,
                                Object msg) {
     ...
     */
            ...
            try {
                 ...
                 if (configStream == null)
                  ...
                  if (configStream != null) {
                        ...
                        //System.err.println(LOGGER_CFG + " could not be loaded properly");
       ...
       * @param msg the message to be logged
       */
      public static void warn(Class objClass,
                              Object msg) {
      ...
      public static boolean isDynamicLogging() {
    	  return dynamicLogging;
      }

      public static void setDynamicLogging(boolean dynamicFlag) {
    	  dynamicLogging = dynamicFlag;
      }
}
